                ...
                <div class="card-header border-bottom border-300 bg-soft">
                    <div class="row g-3 justify-content-between align-items-center">
                        <div class="col-12 col-md">
                            <h4 class="text-900 mb-0" data-anchor="data-anchor" id="soft-buttons">Create branch</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="p-4 code-to-copy">
                        <form action="{{ route('admin.branchs.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="title">branch Başlık</label>
                                <input class="form-control" id="name" name="title" type="text"
                                    placeholder="branch Başlık">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="image">branch Resim</label>
                                <input class="form-control" id="url" name="image" type="file"
                                    placeholder="Resim URL">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="description">branch içerik</label>
