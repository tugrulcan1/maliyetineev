                ...
                <div class="card-header border-bottom border-300 bg-soft">
                    <div class="row g-3 justify-content-between align-items-center">
                        <div class="col-12 col-md">
                            <h4 class="text-900 mb-0" data-anchor="data-anchor" id="soft-buttons">Edit comment</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="p-4 code-to-copy">
                        <form action="{{ route('admin.comments.update', $comment->id) }}" method="POST">
                            ...
                            @method('PUT')
                            <div class="mb-3">
                                <label class="form-label" for="title">comment Title</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="short_content" name="short_content" type="text"
                                    value="{{ $comment->short_content }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="image">İmage</label>
                                <img src="{{ url('uploads/'.$comment->image) }}" alt="">
