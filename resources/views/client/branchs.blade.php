        ...
        <div class="container">
            <div class="row justify-content-center mb-3">
                <div class="col-lg-7 col-md-8 col-sm-9 text-center"
                    ...
                    <h3 class="text-dark-gray fw-700 ls-minus-2px">Şubelerimiz</h3>
                    <p style="text-align: center;">Türkiye genelinde 22 şubemiz ile hizmetinizdeyiz.</p>
                </div>
            </div>
                    ...
                    <div class="bg-very-light-gray feature-box   md-p-13 border-radius-8px justify-content-lg-start"
                        ...
                        <div class="feature-box-content">
                            ...
                            <div class="flex" style="display: flex;  margin-bottom: 5px;">
                                ...
                                <p class="" style="margin: 0; padding: 0; text-align: left;">{!!$branch->description!!}</p>
                            </div>
                            <div class="flex"
