...
@include('client.layouts.partials.footer')
  ...
  <div class="right-fixed-btn d-none d-lg-block"><span><i class="fa fa-envelope-o me-3" aria-hidden="true"></i> Başvuru Formu</span></div>
...
.right-fixed-btn {
            ...
            .right-fixed-btn span {
                color: #fff;
                font-size: 20px;
                text-decoration: 0px 0px 5px #000;
            }
