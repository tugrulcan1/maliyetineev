                ...
                <div class="container-fluid">
                    <div class="d-flex align-items-center">
                        <a class="navbar-brand" href="{{ route('index') }}">
                            ...
                            <img src="images/logomev.png" data-at2x="images/logomev.png" alt
                                class="mobile-logo logo-img">
                        </a>
                    ...
                    <div
                        class=" digital-mgz col-auto text-end d-flex align-items-center justify-content-end d-lg-flex d-flex">
                        <a href="https://emlaksepette.com/magaza/maliyetine-ev/106" class="digitalMagaza"
                            target="_blank" style="margin-right:10px;">Dijital Satış Ofisi</a>
                        <a href="/iletisim" class="phone-link"
                            style="display: flex; align-items: center; color:#000;margin-left:10px">
