...
@section('content')
    ...
    <div class="row justify-content-center align-items-center mb-9 sm-mb-45px">
        ...
        <span class="fs-15 text-uppercase text-base-color fw-600 mb-15px d-block ls-1px" style="">Bizimle iletişime geçin</span>
        <h3 class="fw-700 text-dark-gray ls-minus-1px mb-50px sm-mb-35px" style="">Yardıma mı ihtiyacınız var? Şimdi bizimle iletişime geçin!</h3>

        <div class="icon-with-text-style-01 mb-10 md-mb-35px" style="">
            <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                <div class="feature-box-icon me-25px">
                    <img src="{{asset('demo-marketing-contact-04.jpg')}}" class="h-80px" alt="" data-no-retina="">
                </div>
                <div class="feature-box-content last-paragraph-no-margin">
                    <span class="d-block text-dark-gray fw-600 fs-18 ls-minus-05px mb-5px">Tanışmak için ofisimize bekleriz</span>
        ...
        <div class="icon-with-text-style-01 mb-10 md-mb-35px" style="">
            <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                <div class="feature-box-icon me-25px">
                    <img src="{{asset('demo-marketing-contact-02.jpg')}}" class="h-80px" alt="" data-no-retina="">
                </div>
                <div class="feature-box-content">
                    <span class="d-block text-dark-gray fw-600 fs-18 ls-minus-05px mb-5px">Bizimle iletişime geçmekten çekinmeyin</span>
        ...
        <div class="icon-with-text-style-01" style="">
            <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                <div class="feature-box-icon me-25px">
                    <img src="{{asset('demo-marketing-contact-03.jpg')}}" class="h-80px" alt="" data-no-retina="">
                </div>
                <div class="feature-box-content">
                    <span class="d-block text-dark-gray fw-600 fs-18 ls-minus-05px mb-5px">Size nasıl yardımcı olabiliriz?</span>
                    <div class="w-100 d-block">
