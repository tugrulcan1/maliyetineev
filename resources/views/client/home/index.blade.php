 ...
 @section('content')
     ...
     <section>
         <div class="container" style="overflow: hidden;">
             <div class="row mb-6" style="justify-content:space-between;display:flex;width:100%">
                                             ...
                                             <div class="interactive-banner-style-08" style="">
                                                 <figure class="mb-0 hover-box box-hover position-relative"
                                                    ...
                                                    style="width: 210px; height: 270px; object-fit: cover;" /> --}}
                                                     <img src="{{ $blog->image ? asset('images/' . $blog->image) : asset('images/logomev.png') }}"
                                                         alt class="border-radius-6px"
                                                         style="width: 210px; height: 270px; object-fit: contain;" />
