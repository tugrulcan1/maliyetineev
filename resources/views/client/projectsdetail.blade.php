...
<section class="top-space-margin p-0 full-screen md-h-600px sm-h-500px section-dark position-relative"
        data-parallax-background-ratio="0.8" style="background-image: url('images/banner2.png')">
                        ...
                        <div class="row align-items-center justify-content-center mt-8">
                            ...
                            <div
                                ...
                                <ul class="large-icon dark">
                                    ...
                                    <li class="m-0"><a class="dribbble" href="http://www.dribbble.com/"
                                            target="_blank"><i class="fa-brands fa-linkedin"></i><span></span></a></li>
                                    <li class="m-0"><a class="twitter" href="https://www.twitter.com/"
                                            target="_blank"><i class="fa-brands fa-twitter"></i><span></span></a></li>
    ...
    <section style="padding: 0 !important; ">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h5 class="" style="font-weight: 700; color: #333; margin-bottom: 10px;">Maliyetine Ev Nedir?</h5>
                    <p style="margin: 0;">Hayrına evdir</p>
                </div>
                <div class="col-12">
                    <h5 class="" style="font-weight: 700; color: #333; margin-bottom: 10px;">Maliyetine Ev Nedir?</h5>
                    <p style="margin: 0;">Hayrına evdir</p>
