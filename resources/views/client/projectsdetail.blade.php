...
@section('content')
    ...
    <section id="slider" class="p-0 top-space-margin ">
        <div class="demo-corporate-slider_wrapper fullscreen-container" data-alias="portfolio-viewer" data-source="gallery"
            ...
            <div id="demo-corporate-slider" class="rev_slider bg-regal-blue fullscreenbanner" style="display:none;"
                ...
                <ul>
                    ...
                    <li data-index="rs-01" data-transition="parallaxleft" data-slotamount="default"
                        ...
                        <img src="images/demo-corporate-main-slider-01.jpg" alt="Image"
                            ...
                            <div class="tp-caption  " id="slide-1-layer-04" data-x="['left','left','left','left']"
                                ...
                                <div class="tp-caption" id="slide-1-layer-05" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption mx-auto text-uppercase" id="slide-1-layer-06"
                                        ...
                                        data-paddingright="[0,0,0,0]" data-paddingbottom="[25,25,10,10]"
                                    ...
                                    <div class="tp-caption mx-auto" id="slide-1-layer-07"
                                        ...
                                        data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]"
                                        data-paddingright="[0,0,0,0]" data-paddingbottom="[33,28,35,25]"
                                    ...
                                    <div class="tp-caption mx-auto" id="slide-1-layer-08"
                                        ...
                                        data-fontweight="['300','300','300','300']" data-letterspacing="['0','0','0','0']"
                                        data-color="['#ffffff','#ffffff','#ffffff','#ffffff']"
                                        ...
                                        data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]"
                                        data-paddingright="[0,0,0,0]" data-paddingbottom="[36,36,60,40]"
                                        data-paddingleft="[0,0,0,0]">
                    ...
                    <li data-index="rs-02" data-transition="parallaxleft" data-slotamount="default"
                        ...
                        <img src="images/demo-corporate-main-slider-02.jpg" alt="Image"
                            data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                            class="rev-slidebg" data-no-retina>
                    ...
                    <li data-index="rs-03" data-transition="parallaxleft" data-slotamount="default"
                        ...
                        <img src="images/demo-corporate-main-slider-03.jpg" alt="Image"
                            data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                            class="rev-slidebg" data-no-retina>
