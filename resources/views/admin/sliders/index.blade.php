...
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                <div id="sliderSummary"
                    data-list='{"valueNames":["sliderName","assigness","start","deadline","task","sliderprogress","status","action"],"slider":12,"pagination":true}'>
                    <div class="row justify-content-between mb-4 gx-6 gy-3 align-items-center">
                        <div class="col-auto">
                            <h2 class="mb-0">Sayfalar<span class="fw-normal text-700 ms-3">({{ count($sliders) }})</span>
                            </h2>
                        </div>
                        <div class="col-auto">
                            <div class="col-auto">
                                <a class="btn btn-primary px-5" href="{{ route('admin.sliders.create') }}">
                    ...
                    <div class="card shadow-none border border-300 my-4 p-5">
                        ...
                        <div
                            ...
                            <div class="d-flex"><button class="slider-link" data-list-pagination="prev"><span
                                        class="fas fa-chevron-left"></span></button>
                                <ul class="mb-0 pagination"></ul><button class="slider-link pe-0"
