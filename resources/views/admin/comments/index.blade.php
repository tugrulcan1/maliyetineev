        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="commentSummary"
                    data-list='{"valueNames":["commentName","assigness","start","deadline","task","commentprogress","status","action"],"comment":12,"pagination":true}'>
                    <div class="row justify-content-between mb-4 gx-6 gy-3 align-items-center">
                        <div class="col-auto">
                            <h2 class="mb-0">Sayfalar<span class="fw-normal text-700 ms-3">({{ count($comments) }})</span>
                            </h2>
                        </div>
                        <div class="col-auto">
                            <div class="col-auto">
                                <a class="btn btn-primary px-5" href="{{ route('admin.comments.create') }}">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            data-sort="commentName" style="width:20%;">comment BAŞLIK</th>
                                            <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            data-sort="commentName" style="width:20%;">comment İÇERİK</th>
                                            <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            data-sort="commentName" style="width:20%;">RESİM</th>
                                        <th>İŞLEMLER</th>
                                ...
                                <tbody class="list" id="comment-list-table-body">
                                    @foreach ($comments as $key => $comment)
                                        <tr class="position-static">
                                            ...
                                            <td><img src="{{ url('uploads/'.$comment->image) }}" alt="" style="" width="200px" height="100px"></td>
                                            <td>
                                                @if (in_array('GetCommentById', $userPermissions) && in_array('UpdateComment', $userPermissions))
                                                    <a href="{{ route('admin.comments.edit', $comment->id) }}"
                                                        class="btn btn-sm btn-primary">Güncelle</a>
                                                @elseif (in_array('GetCommentById', $userPermissions))
                                                    <a href="{{ route('admin.comments.edit', $comment->id) }}"
                                                        class="btn btn-sm btn-primary">Önizle</a>
                                                @endif
                                                @if (in_array('DeleteComment', $userPermissions))
